sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("zjblessons/ControlTaskSidorovich/app", ".html");
		...
		return Opa5.extend("zjblessons.ControlTaskSidorovich.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["zjblessons/ControlTaskSidorovich/localService/mockserver"], function (mockserver) {
